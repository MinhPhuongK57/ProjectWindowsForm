...
namespace _452_417_CDTH19E_SHOESSHOP
{
    public partial class frmChiTietHoaDon : Form
    {
        ...
        void HienThiTextbox(int vitri)
        {
            ...
            txtDonGia.Text = ChiTietHoaDon.Rows[vitri][2].ToString();
            numSoLuongSP.Value = Convert.ToInt32(ChiTietHoaDon.Rows[vitri][3]);
            txtGiamGia.Text = ChiTietHoaDon.Rows[vitri][4].ToString();
            txtThanhTien.Text = ChiTietHoaDon.Rows[vitri][5].ToString();
        }
        //Button Thoát
        ...
        bool KiemTraIDCTHD()
        {
            ...
            {
                if (txtIDHoaDon.Text == ChiTietHoaDon.Rows[i][0].ToString())
                {
                    return true;
                    break;
                }
